...
if (
    ...
    $list_khachhang = $khach_hang->getPaginationLichKhamByNgayKham($limit, $offset, $startDate, $endDate, $sdt);
    $total_articles = $khach_hang->getTotalCountByNgayKham($startDate, $endDate, $sdt);
